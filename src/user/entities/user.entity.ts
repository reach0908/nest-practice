import { Entity, PrimaryGeneratedColumn, Column, ManyToOne, JoinTable, OneToMany, OneToOne, ManyToMany } from 'typeorm'
...
export class User {
    ...
    @OneToOne(() => SprintSetting, (setting: SprintSetting) => SprintSetting.user)
